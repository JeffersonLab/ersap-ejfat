package org.jlab.epsci.ersap.ejfat.io.engine.vtp;

import com.lmax.disruptor.*;
import org.jlab.epsci.ersap.ejfat.io.sandbox.vtp.VAggregator;
import org.jlab.epsci.ersap.ejfat.io.sandbox.vtp.VReceiver;
import org.jlab.epsci.ersap.ejfat.io.sandbox.vtp.VRingRawEvent;
import org.jlab.epsci.ersap.ejfat.io.sandbox.vtp.VRingRawEventFactory;
 ...
 * Phone : (757)-269-7100
 *
 * @author gurjyan on 5/11/22
 * @project ersap-ejfat
 */
public class VtpOldFormatReader {
    /**
     * VTP ports
     */
    ...
    private VtpOldFormatReader(int vtpPort1, int vtpPort2, int vtpPort3,
